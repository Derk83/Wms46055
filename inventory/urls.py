...
urlpatterns = [
    ...
    path(
        ...
        training_views.warehouse_training_progress,
        name="warehouse_training_progress",
    ),
    ...
    path("material-requests/<int:pk>/claim/", views.material_request_claim, name="material_request_claim"),
    path("api/material-requests/<int:pk>/claim-push/", views.material_request_claim_push, name="material_request_claim_push"),
