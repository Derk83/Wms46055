...
def test_complete_guided_demo_changes_only_session_backed_fictional_state(client):
    ...
    response = _post(client, "create_request")
    assert response.status_code == 302
    response = _get(client)
