...
A Django warehouse-management system (WMS) for RPL Warehouse, deployed at
...
| `DEFAULT_FROM_EMAIL` | Override the default `From:` header (default: `RPL Warehouse <noreply@rplwms.com>`) |
